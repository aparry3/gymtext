...
\r
`,a,"\r\n")),e.push(`--${d}--`),new c(e,{type:"multipart/form-data; boundary="+d})}a.s(["FormData",0,l,"formDataToBlob",()=>m])},387472,(a,b,c)=>{if(!globalThis.DOMException)try{let{MessageChannel:b}=a.r(37702),c=new b().port1,d=new ArrayBuffer;c.postMessage(d,[d,d])}catch(a){"DOMException"===a.constructor.name&&(globalThis.DOMException=a.constructor)}b.exports=globalThis.DOMException},552499,670552,a=>{"use strict";var b=a.i(902157),c=a.i(750227),d=a.i(387472),e=a.i(546403),f=a.i(496624);let{stat:g}=b.promises,h=(a,c)=>l((0,b.statSync)(a),a,c),i=(a,b)=>g(a).then(c=>l(c,a,b)),j=(a,b)=>g(a).then(c=>m(c,a,b)),k=(a,c)=>m((0,b.statSync)(a),a,c),l=(a,b,c="")=>new f.default([new n({path:b,size:a.size,lastModified:a.mtimeMs,start:0})],{type:c}),m=(a,b,d="")=>new e.default([new n({path:b,size:a.size,lastModified:a.mtimeMs,start:0})],(0,c.basename)(b),{type:d,lastModified:a.mtimeMs});class n{#h;#i;constructor(a){this.#h=a.path,this.#i=a.start,this.size=a.size,this.lastModified=a.lastModified}slice(a,b){return new n({path:this.#h,lastModified:this.lastModified,size:b-a,start:this.#i+a})}async *stream(){let{mtimeMs:a}=await g(this.#h);if(a>this.lastModified)throw new d.default("The requested file could not be read, typically due to permission problems that have occurred after a reference to a file was acquired.","NotReadableError");yield*(0,b.createReadStream)(this.#h,{start:this.#i,end:this.#i+this.size-1})}get[Symbol.toStringTag](){return"Blob"}}a.s(["blobFrom",()=>i,"blobFromSync",()=>h,"fileFrom",()=>j,"fileFromSync",()=>k],552499),a.s(["File",()=>e.default],670552)}];

//# sourceMappingURL=node_modules__pnpm_63a57326._.js.map