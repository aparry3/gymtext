    ...
    <Collapsible>
      ...
      <CollapsibleContent className="px-4 pt-2 pb-1 space-y-3">
        {examples.map((example, index) => (
          <div key={index} className="rounded-lg border p-3 space-y-2 bg-gray-50/50">
            ...
            <div className="space-y-1">
              ...
              <textarea
                className="w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm font-mono resize-y min-h-[60px]"
                value={example.input}
            ...
            {example.type === 'negative' && (
              <div className="space-y-1">
                ...
                <textarea
                  className="w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm font-mono resize-y min-h-[40px]"
