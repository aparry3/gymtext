...
import { validateFile, parseFile, createServicesFromDb, postgresDb } from '@gymtext/shared/server';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await services.programAgent.parseProgram(parsed.text);
