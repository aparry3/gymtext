...
"[project]/packages/shared/src/server/services/auth/adminAuthService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AdminAuthService {
    ...
    CODE_LENGTH = 6;
    // Dev mode detection
    isDev = !(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$config$2f$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEnvironmentSettings"])().isProduction;
    devBypassCode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$shared$2f$config$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getAdminConfig"])().devBypassCode || '000000';
    constructor(){
        this.authRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$repositories$2f$userAuthRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserAuthRepository"]();
    }
    /**
   ...
   */ isPhoneWhitelisted(phoneNumber) {
        const { phoneNumbers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$shared$2f$config$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getAdminConfig"])();
   ...
   */ async requestCode(phoneNumber) {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$connections$2f$twilio$2f$twilio$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["twilioClient"].sendSMS(phoneNumber, message);
...
"[project]/packages/shared/src/server/services/auth/userAuthService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$auth$2f$adminAuthService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/shared/src/server/services/auth/adminAuthService.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$config$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/shared/src/server/config/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$config$2f$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/shared/src/server/config/settings.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$shared$2f$config$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/shared/src/shared/config/index.ts [app-route] (ecmascript) <locals>");
;
...
class UserAuthService {
   ...
   */ async requestVerificationCode(phoneNumber) {
        try {
            ...
            const isAdmin = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$auth$2f$adminAuthService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminAuthService"].isPhoneWhitelisted(phoneNumber);
            if (!user && !isAdmin) {
                return {
                    success: false,
   ...
   */ createSessionToken(userId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$utils$2f$sessionCrypto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["encryptUserId"])(userId);
    }
    /**
   * Clean up expired auth codes (should be run periodically)
   */ async cleanupExpiredCodes() {
...
"[project]/apps/web/src/app/api/users/signup/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$stripe$40$14$2e$25$2e$0$2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/stripe@14.25.0/node_modules/stripe/esm/stripe.esm.node.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$auth$2f$userAuthService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/shared/src/server/services/auth/userAuthService.ts [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$userService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userService"].getUserByPhone(formData.phoneNumber);
        if (existingUser) {
            const subscriptionRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$repositories$2f$subscriptionRepository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SubscriptionRepository"]();
 ...
 */ async function handleNewUserSignup(formData) {
    // Step 1: Create user (basic info only)
    console.log('[Signup] Creating user with basic info');
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$userService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userService"].createUser({
        name: formData.name,
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$userService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userService"].updateUser(user.id, {
 ...
 */ async function handleUnsubscribedUserSignup(existingUser, formData) {
    // Update existing user with new form data
    console.log('[Signup] Updating existing user info');
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$userService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userService"].updateUser(existingUser.id, {
        name: formData.name,
        age: formData.age ? parseInt(formData.age, 10) : undefined,
        gender: formData.gender,
        timezone: formData.timezone,
 ...
 */ async function handleSubscribedUserReOnboard(existingUser, formData) {
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$onboardingDataService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["onboardingDataService"].delete(existingUser.id);
    } catch  {
    // Ignore if no existing record
    }
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$onboardingDataService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["onboardingDataService"].createOnboardingRecord(existingUser.id, extractSignupData(formData));
    ...
    const sessionToken = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$auth$2f$userAuthService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userAuthService"].createSessionToken(existingUser.id);
    const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true,
        redirectUrl: '/me'
    });
    response.cookies.set('gt_user_session', sessionToken, {
        httpOnly: true,
        secure: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$shared$2f$config$2f$public$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isProductionEnvironment"])(),
        sameSite: 'lax',
        maxAge: 30 * 24 * 60 * 60,
        path: '/'
    });
 ...
 */ async function completeSignupFlow(userId, stripeCustomerId, formData, forceCreate) {
    // Reset onboarding record if exists, create fresh
    console.log('[Signup] Creating onboarding record');
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$onboardingDataService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["onboardingDataService"].delete(userId);
    } catch  {
    // Ignore if no existing record
    }
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$onboardingDataService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["onboardingDataService"].createOnboardingRecord(userId, extractSignupData(formData));
    // Send welcome SMS
    console.log('[Signup] Sending welcome SMS');
    const userWithProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$userService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userService"].getUser(userId);
    if (userWithProfile) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$messaging$2f$messageService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["messageService"].sendWelcomeMessage(userWithProfile);
    }
    ...
    if (referralCode) {
        ...
        const userWithProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$user$2f$userService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userService"].getUser(userId);
        const validation = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$referral$2f$referralService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["referralService"].validateReferralCode(referralCode, userWithProfile?.phoneNumber);
        if (validation.valid) {
            validReferralCode = referralCode.toUpperCase();
            // Get or create the referral coupon in Stripe
            refereeCouponId = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$referral$2f$referralService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["referralService"].getRefereeCouponId();
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$referral$2f$referralService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["referralService"].completeReferral(validReferralCode, userId);
        } else {
    ...
    const sessionToken = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$server$2f$services$2f$auth$2f$userAuthService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userAuthService"].createSessionToken(userId);
    const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true,
 ...
 */ function extractSignupData(formData) {
    return {
        primaryGoals: formData.primaryGoals,
        goalsElaboration: formData.goalsElaboration,
        experienceLevel: formData.experienceLevel,
        desiredDaysPerWeek: formData.desiredDaysPerWeek,
        availabilityElaboration: formData.availabilityElaboration,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e8a0919._.js.map