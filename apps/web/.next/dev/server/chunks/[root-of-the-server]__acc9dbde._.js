...
"[project]/apps/web/src/app/api/checkout/session/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        const existingSubscription = await subscriptionRepo.findByStripeId(session.subscription);
        if (existingSubscription) {
            console.log(`[Checkout Session] Subscription already exists: ${existingSubscription.id}`);
        } else {
        ...
        try {
            ...
            if (sent) {
                ...
                console.log(`[Checkout Session] Waiting for onboarding to complete for user ${userId}`);
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__acc9dbde._.js.map