    ...
    <div className="relative min-h-[100vh] md:min-h-[90vh] flex items-center justify-center bg-black overflow-hidden pb-24 md:pb-28">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#002D72]/90 via-black/60 to-black/80"></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-16 lg:pt-0">
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto mb-8 md:mb-10 font-light px-2">
          National Champion Mikey Swiercz was known for his versatility, leadership, and fitness.
          <br className="hidden md:block" /> Now, he&apos;s putting his training regimen in your
          pocket.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link
            href="/start"
            className="group bg-white text-[#002D72] px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.3)] flex items-center gap-2"
          >
            Get The Workouts
