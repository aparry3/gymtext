...
export function NextLevelStatsBar() {
  return (
    <div className="bg-nlb-orange relative z-20 -mt-16 md:-mt-20 mx-4 md:mx-8 lg:mx-auto max-w-6xl rounded-2xl shadow-2xl border-t border-white/10 p-6 md:p-12">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
        {STATS.map((stat, index) => (
          <div key={index} className="text-center group">
            ...
            <div className="text-orange-100 text-xs md:text-base font-medium tracking-wide uppercase">
              {stat.label}
            </div>
          </div>
        ))}
