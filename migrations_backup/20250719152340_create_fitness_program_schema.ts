...
export async function up(db: Kysely<DB>): Promise<void> {
  ...
  // Create fitness_plans table (unchanged)
  await db.schema
  ...
  // Create mesocycles table (simplified - removed status)
  await db.schema
  ...
  // Create microcycles table (simplified - removed status, metrics)
  await db.schema
  ...
  // Create workout_instances table (simplified - removed status, feedback, metrics)
  await db.schema
  ...
  // Add simple check constraint for workout_instances (removed complex status constraint)
  await sql`
