...
import { buildProfileUpdateUserMessage, buildUserFieldsUserMessage, buildStructuredProfileUserMessage, } from '../prompts/profile';
import { ProfileUpdateOutputSchema, UserFieldsOutputSchema, } from '../schemas/profile';
    ...
    static async updateProfile(userId, message, previousMessages) {
        ...
        try {
            ...
            if (profileResult.wasUpdated) {
                await fitnessProfileService.saveProfileWithStructured(userId, profileResult.updatedProfile, profileResult.structured);
            ...
            if (userFieldsResult.hasUpdates && Object.keys(userFieldsResult).some(k => k !== 'hasUpdates' && k !== 'updateSummary' &&
                userFieldsResult[k] !== null)) {
