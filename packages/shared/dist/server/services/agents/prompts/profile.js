...
`;
export function buildProfileUpdateUserMessage(currentProfile, message, user, currentDate) {
    return `## CONTEXT
 ...
 */
export function buildUserFieldsUserMessage(message, user, currentDate) {
 ...
 */
export function buildStructuredProfileUserMessage(dossierText, currentDate) {
    return `## CURRENT DATE
${currentDate}
