...
`;
export const modifyWorkoutUserPrompt = (user, workoutOverview, changesRequested) => `
...
`;
export function workoutSmsUserPrompt(workoutDescription) {
    return `
...
export const structuredWorkoutUserPrompt = (description) => `Parse the following workout into structured format:
