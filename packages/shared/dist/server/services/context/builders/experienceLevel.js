 ...
 */
export const fetchExperienceLevelSnippet = async (experienceLevel, snippetType) => {
    if (!experienceLevel) {
        return null;
    }
 ...
 * ```
 */
export const buildExperienceLevelContext = (snippet, experienceLevel, snippetType) => {
