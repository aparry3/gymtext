...
import { MAX_REFERRAL_CREDITS, REFERRAL_CREDIT_AMOUNT_CENTS, } from '@/server/models/referral';
...
export class ReferralService {
    ...
    async creditReferrer(refereeUserId) {
        ...
        try {
            ...
            await this.referralRepo.markCreditApplied(referral.id, REFERRAL_CREDIT_AMOUNT_CENTS);
