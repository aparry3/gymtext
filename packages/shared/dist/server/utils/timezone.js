 ...
 */
export function getLocalHourForTimezone(utcDate, timezone) {
 ...
 */
export function convertPreferredHourToUTC(localHour, timezone) {
    if (!isValidIANATimezone(timezone)) {
        throw new Error(`Invalid IANA timezone: ${timezone}`);
    }
 ...
 */
export function getAllUTCHoursForLocalHour(localHour, timezone) {
    if (!isValidIANATimezone(timezone)) {
        throw new Error(`Invalid IANA timezone: ${timezone}`);
    }
    const hours = new Set();
