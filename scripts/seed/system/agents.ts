...
- [ ] Modifications are appropriate for the training modality`,
    ...
    is_active: true,
    tool_ids: [],
    user_prompt_template: `Modify the existing microcycle based on:\n\n{{input}}\n\nIf targeting a specific day, ONLY change that day. Preserve all other days exactly as written.\nUse strikethrough for changes and append a LOG section.`,
    examples: null,
    eval_rubric: null,
    output_schema: null,
  },
