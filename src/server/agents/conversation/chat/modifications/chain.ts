...
import type { UpdateWorkoutResult, ModifyWeekResult } from '@/server/services';
...
type ModificationResult = UpdateWorkoutResult | ModifyWeekResult;
 ...
 *
 * @param deps - Dependencies including modification tools (DI pattern)
 * @returns Runnable that processes modification requests
 */
export const createModificationsAgent = (deps: ModificationsAgentDeps): RunnableLambda<ChatSubagentInput, ModificationsResponse> => {
