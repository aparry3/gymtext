...
The "description" field should be a THOROUGH, DETAILED long-form workout plan (600-900 words).
...
The "reasoning" field should document ALL decision-making (600-900 words).
...
- Example: "I chose straight sets for the main lifts because ${user.name} is in a strength phase and needs full recovery between sets to maximize force production. Supersets would compromise the primary strength goal."

**Exercise Selection:**
- Why these SPECIFIC exercises (not just categories)
- How they align with today's theme (${dayPlan.theme})
- How they fit the mesocycle focus (${mesocycle.focus.join(', ')})
- Connection to user's primary goals with explicit reasoning
- Why alternatives were rejected

**Progressive Overload:**
- How this workout builds on recent training history
- Volume/intensity decisions based on mesocycle week
...
**Program Integration:**
- How this workout advances the ${programType} program
- Placement within ${mesocycle.name} strategy
- Balance with other training days this week
- Avoid overlap/interference with recent sessions
- Preparation for upcoming training days
...
**Be thorough** - this reasoning will be referenced when users ask "why this exercise?", "why not supersets?", or "how does this help my goal?"
