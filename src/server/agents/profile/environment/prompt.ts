...
- Examples:
  - "I'm at the beach this week" → TEMPORARY (add to temporaryChanges)
...
- "I'm at the beach this week, only bodyweight equipment"
  → temporaryChanges: [{
      id: "temp-beach-001",
...
For "I'm at the beach this week, can we do beach workouts":
{
  "data": {
    "equipmentAccess": {
      "temporaryChanges": [
